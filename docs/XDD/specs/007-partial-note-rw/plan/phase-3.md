...
- [ ] **T3.1 `mapReadRequest` — read mode validation & normalization** `[activity: backend-api]`
...
- [ ] **T3.2 `mapWriteRequest` — write mode validation & normalization** `[activity: backend-api]`
