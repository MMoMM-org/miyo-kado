...
- [ ] **T3.1 OpenNotesSection component** `[activity: frontend-ui]`
...
- [ ] **T3.2 ApiKeyTab integration** `[activity: frontend-ui]` `[parallel: true]`
...
- [ ] **T3.3 GlobalSecurityTab integration** `[activity: frontend-ui]` `[parallel: true]`
...
- [ ] **T3.4 End-to-End live testing** `[activity: validate]`
